...
สคริป แชท : [Script Chat Mods 4.0](chatmods4_0.txt) | แก้ไขแชทให้กว้างและควบคุมวิทยุ<br>
**หมายเหตุ :** 
...
- Click Farm 8.5 ควรติดตั้งคู่กับ Script Chat Mods 4.0 เพื่อไม่ให้วิทยุทำงานเองหลังเก็บผลผลิต
...
- วิทยุอาจทำงานตอนโหลดหน้าใหม่ ควรควรติดตั้ง [Script Chat Mods 4.0](chatmods4_0.txt) เพื่อปิดวิทยุตอนเข้าหน้าแชท</details>

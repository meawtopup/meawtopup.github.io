...
1. ระบบเก็บตั๋ว 🎫
   ...
   - ปุ่ม "🎫เก็บตั๋ว" ใช้ได้เมื่อสถานะตั๋ว "✔️ตั๋วพร้อมเก็บ"
   - ปุ่ม "🎫พร้อมใช้งาน" แสดงเมื่อฟังชั่นกำลังทำงานและไม่มีข้อผิดพลาด
   - ปุ่ม "🎫โดรน: ปิด/เปิด" สำหรับเปิดออโต้ไว้เก็บตามเวลา
2. ระบบทำฟาร์ม 🌾
   - ปุ่มสถานะฟาร์ม: ⏳กำลังเช็คฟาร์ม/✔️พร้อมเก็บ/✔️พร้อมปลูก/❌รอโต/❌เงินไม่พอปลูก(Zen ต่ำกว่า 25,000)
   - ปุ่ม "🌾เก็บผัก" หรือ "🌾ปลูกผัก" ใช้ได้เมื่อสถานะฟาร์ม "✔️พร้อมเก็บ" หรือ "✔️พร้อมปลูก"
   - ปุ่ม "🌾พร้อมใช้งาน" แสดงเมื่อฟังชั่นกำลังทำงานและไม่มีข้อผิดพลาด
   - ปุ่ม "🌾โดรน: ปิด/เปิด" สำหรับเปิดออโต้ไว้เก็บตามเวลา
3. ระบบจัดการและความเสถียร
   - ระบบคำนวณเวลาข้ามรอบอัตโนมัติ ของระบบตั๋ว
   - ฟังก์ชันระบบรักษาเวลาความแม่นยำสูง
   - จดจำการตั้งค่า เปิด/ปิด ออโต้
   - มีระบบจัดการหน่วยความจำไม่ให้เกิด Memory Leak
...
5. ระบบคิวรอดาวโหลด (สามารถกดหลาย DL-Now หลายไฟล์ได้เลย แต่ห้ามเปลี่ยนหน้าหรือหลุดโฟกัส)
...
*อัพเดทเมื่อ 15/6/2569*  
1. แก้ปัญหาผู้ใช้ 3BB ที่เข้าเว็บไม่ได้หรือติด CloudFlare: Error code 524  
   (เกิดจาก IPv6 ของ 3BB โดนปิดกั้นทำให้เข้า CloudFlare ไม่ได้)  
...
4. มีฟังชั่น Flush DNS ที่ยังค้างอยู่
5. สคริปนี้ไม่บล็อคการทำงานของ IPv4 ในการหาเพียร์ของโปรแกรมบิททอเร้นท์

**หมายเหตุ :** 
- มีผลเฉพาะบราวเซอร์ Chrome, Firefox, Edge, Brave, Opera, OperaGX, Safari  

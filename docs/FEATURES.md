...
2. ระบบทำฟาร์ม
   ...
   - ระบบปลูก/เก็บออโต้
   - ระบบเช็คเงิน (ต้องมี Zen มากกว่า 25,000Zen ออโต้ถึงทำงาน)
...
**หมายเหตุ :**  
- เมื่อเก็บตั๋ว/ผัก เสร็จสิ้น ⚠️สคริปจะรีโหลดหน้าใหม่เพื่อเคลียเมมโมรี⚠️ 
- ควรติดตั้งคู่กับสคริป Chat Mods หรือ Radio เพื่อไม่ให้วิทยุทำงานเองหลังรีโหลดหน้าใหม่
- แสดงปุ่มจัดการที่หน้า Chat เท่านั้น
...
- แสดงปุ่มจัดการที่หน้า Farm เท่านั้น
# Click Farm 9.0  
...
- แสดงปุ่มจัดการที่หน้า Chat และ Farm
- ตำแหน่งปุ่มจัดการอยู่ข้างปุ่ม เปิด/ปิด เมนูของเว็บ

...
สคริป ทำเกษตร : [Script Click Farm 8.5](clickfarm8_5.txt) | ระบบออโต้ แต่รันบนหน้า Chat<br>
...
- Click Farm 8.5 ต้องเปิดหน้า Chat ทิ้งไว้ ไม่จำเป็นต้องเปิดหน้า Farm (รันสคริปเกษตร+ลอยคอคอยเหรียญ)
- Click Farm 8.5 ควรติดตั้งคู่กับ Script Chat Mods 4.3 เพื่อไม่ให้วิทยุทำงานเองหลังเก็บผลผลิต
...
<details><summary>Click Farm 8.5</summary>
